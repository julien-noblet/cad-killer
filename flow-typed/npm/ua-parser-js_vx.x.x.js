...
declare class _Browser { name: string, version: string };

var _DeviceType: "console" | "mobile" | "tablet" | "smarttv" | "wearable" | "embedded";

declare class _Device { model: string, type: _DeviceType, vendor: string };

declare class _Engine { name: string, version: string };

declare class _OS { name: string, version: string };

declare class _CPU { architecture: string };
